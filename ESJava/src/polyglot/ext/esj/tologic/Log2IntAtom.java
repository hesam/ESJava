...
public class Log2IntAtom  {
    ...
    public Log2IntAtom(IntExpression expression) {
	super();
	...
	return expression.eq(o2.var_log2().expression().sum());
    }
    
    public Formula gt(ESJObject o2) {
	return expression.gt(o2.var_log2().expression().sum());
    }
    
    public Formula gte(ESJObject o2) {
	return expression.gte(o2.var_log2().expression().sum());
    }
    
    public Formula lt(ESJObject o2) {
	return expression.lt(o2.var_log2().expression().sum());
    }
    
    public Formula lte(ESJObject o2) {
	return expression.lte(o2.var_log2().expression().sum());
    }
